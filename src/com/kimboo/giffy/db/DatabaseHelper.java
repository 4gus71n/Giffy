...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    /**
     * Returns the Database Access Object (DAO) for our Gif class. It will create it or just give the cached
     * value.
     */
    public Dao<Gif, Integer> getDao() throws SQLException {
        if (gifDao == null) {
     ...
     */
    public RuntimeExceptionDao<Gif, Integer> getGifDao() {
        if (gifRuntimeDao == null) {
            gifRuntimeDao = getRuntimeExceptionDao(Gif.class);
        }
        return gifRuntimeDao;
    }
